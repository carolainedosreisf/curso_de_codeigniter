                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <input type="text" id="txt-titulo" name="txt-titulo" class="form-control" placeholder="Digite o título..." value="<?php echo set_value('txt-titulo');?>">
                                   </div>
                                   <div class="form-group">
                                       <label id="txt-subtitulo">Subtítulo</label>
                                       <input type="text" id="txt-subtitulo" name="txt-subtitulo" class="form-control" placeholder="Digite o subtítulo.." value="<?php echo set_value('txt-subtitulo');?>">
                                   </div>
                                   <div class="form-group">
                                ...
                                <style>
                                    ...
                                    <?php 
                                        ...
                                        foreach($publicacoes as $publicacao){
                                            ...
                                            $alterar= anchor(base_url('index.php/admin/publicacao/alterar/'.md5($publicacao->id)), '<i class="fa fa-refresh fa-fw fa-admin"> Alterar');//arrumar essa rota
                                            $excluir= anchor(base_url('index.php/admin/publicacao/excluir/'.md5($publicacao->id)),'<i class="fa fa-remove fa-fw fa-admin"> Excluir'); //arrumar essa rota
