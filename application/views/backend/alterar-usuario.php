                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <input type="email" id="txt-email" name="txt-email" class="form-control" placeholder="Digite o email.." value="<?php echo $usuario->email;?>">
                                   </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <input type="text" id="txt-user" name="txt-user" class="form-control" placeholder="Digite o user..." value="<?php echo $usuario->user;?>">
                                   </div>
                                   <div class="form-group">
