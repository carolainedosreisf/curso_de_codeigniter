...
class Contato extends CI_Controller {
	...
	public function enviar_mensagem(){
		...
		if($this->form_validation->run()){
			...
			$this->email->to('caroldosreis97@gmail.com');
			...
			if($this->email->send()){
				redirect(base_url("index.php/contato/1")); //arrumar essa rota //sucesso
			}else{
				redirect(base_url("index.php/contato/2")); // arrumar essa rota //erro
			}
